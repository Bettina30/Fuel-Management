...
(2, 1, 'Lobster Thermidor', 'Lobster Thermidor is a French item of lobster meat cooked in a rich wine sauce, stuffed back into a lobster shell, and browned.', '36.00', '629089fee52b9.jpg'),
...
(5, 2, 'Pink Spaghetti Gamberoni', 'Spaghetti with prawns in a fresh tomato sauce. This item originates from Southern Italy and with the combination of prawns, garlic, chilli and pasta. Garnish each with remaining tablespoon parsley.', '21.00', '606d7491a9d13.jpg'),
...
--
-- Table structure for table `petrolpump`
--
...
--
-- Dumping data for table `petrolpump`
--

INSERT INTO `petrolpump` (`rs_id`, `c_id`, `title`, `email`, `phone`, `url`, `o_hr`, `c_hr`, `o_days`, `address`, `image`, `date`) VALUES
...
(1, 'Hindusthan central public sector', '2022-05-27 08:07:35'),
(2, 'Indian  central public sector', '2021-04-07 08:45:23'),
(3, 'Bharath central public sector', '2021-04-07 08:45:25'),
(4, 'shell central public sector', '2021-04-07 08:45:28');
...
--
-- AUTO_INCREMENT for table `petrolpump`
--
ALTER TABLE `petrolpump`
